...
<div class="tab-content" style="margin-top: 5px">
    {{--商品基本描述--}}
    @include('admin.good.partials._form_base')
    {{--商品描述--}}
    @include('admin.good.partials._form_desc')
    {{--会员价格--}}
    @include('admin.good.partials._form_ml')
    {{--商品属性--}}
    @include('admin.good.partials._form_set')
    {{--商品相册--}}
    @include('admin.good.partials._form_pic')
</div>
