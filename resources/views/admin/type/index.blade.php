                ...
                <script>
                    $(function () {
                            ...
                            columnDefs: [
                                {
                                    ...
                                    var caozuo = '<a style="margin:3px;" href="/admin/attribute/' + row['id'] + '" class="X-Small btn-xs text-default "><i class="fa fa-edit"></i> 属性</a>';
                        ...
                        $("table").delegate('.delBtn', 'click', function () {
                            ...
                            $('.deleteForm').attr('action', '/admin/type/' + id);
                            $("#modal-delete").modal();
                        });
